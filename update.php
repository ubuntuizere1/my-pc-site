...
echo "<table><tr><th id=td>Operating System</td> <th id=td>System Type</td> <th id=td>Serial Number</td> <th id=td>Ram</td> <th id=td>Processor</td> <th id=td>Bios Model</th> <th id=td>Hard Disk</th> <th id=td>Update</th>";
...
echo "<td id=td><a href='edit2.php?serial=".$query2['serial']."'><img src=edit.png height=22 width=22></a></td></<tr>";
}
?>
